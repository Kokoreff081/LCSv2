...
public class TrackV4 : BaseVC
{
    ...
    {
        LcsServer.Models.LCProjectModels.Models.ScenarioObjects.Track track = new LcsServer.Models.LCProjectModels.Models.ScenarioObjects.Track(Id, Name, ParentId, EffectIds, Starts,
            UseParentRaster, RasterId, RiseTime, FadeTime, IsEnabled, DimmingLevel, Opacity);
    ...
    {
        if (baseVC is not TrackV3 trackV3)
        {
            return;
        }
        ...
        Starts = trackV3.Starts;
        EffectIds = trackV3.EffectIds;
        RasterId = trackV3.RasterId;
        UseParentRaster = trackV3.UseParentRaster;
        Opacity = 1.0f;
    }
}