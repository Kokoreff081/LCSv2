    ...
    public class ParameterDescription
    {
        ...
        public class GetReply : RdmResponsePacket
        {
            ...
            protected override void ReadData(RdmBinaryReader data)
            {
                ...
                CommandClass = (CommandClass) data.ReadByte();
                Type = data.ReadByte();
                Unit = (SensorDefinition.SensorUnit) data.ReadByte();
                Prefix = (SensorDefinition.SensorPrefix) data.ReadByte();
