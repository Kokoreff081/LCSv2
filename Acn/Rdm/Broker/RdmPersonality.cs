...
namespace Acn.Rdm.Broker
{
    public class RdmPersonality:List<RdmSlot>
    {
        public void Add8BitChannel(SlotIds id, string description, byte defaultValue)
        {
            ...
            slot.Information = new SlotInfo.SlotInformation((short) Count, id);
            slot.Description = description;
            slot.DefaultValue = new DefaultSlotValue.SlotValue((short) Count,defaultValue);
            Add(slot);
        }
        ...
        public void Add8BitChannel(SlotTypes linkType, int linkOffset, string description, byte defaultValue)
        {
            ...
            slot2.Information = new SlotInfo.SlotInformation((short)Count, linkType, (short)linkOffset);
            slot2.Description = description;
            slot2.DefaultValue = new DefaultSlotValue.SlotValue((short)Count, defaultValue);
            Add(slot2);
        }
        ...
        public void Add16BitChannel(SlotIds id, string description, byte defaultValue)
        {
            ...
            slot1.Information = new SlotInfo.SlotInformation((short) Count, id);
            slot1.Description = description;
            slot1.DefaultValue = new DefaultSlotValue.SlotValue((short)Count, defaultValue);
            Add(slot1);

            RdmSlot slot2 = new RdmSlot();
            slot2.Information = new SlotInfo.SlotInformation((short) Count, SlotTypes.Fine, (short)Count);
            slot2.Description = description;
            slot2.DefaultValue = new DefaultSlotValue.SlotValue((short)Count, defaultValue);
            Add(slot2);
        }
        ...
        {
            RdmSlot slot1 = new RdmSlot();
            slot1.Information = new SlotInfo.SlotInformation((short)Count, linkType, (short)linkOffset);
            slot1.Description = description;
            slot1.DefaultValue = new DefaultSlotValue.SlotValue((short)Count, defaultValue);
            Add(slot1);
        ...
        protected RdmPacket GetSlotDescription(RdmPacket packet)
        {
            ...
            if (requestPacket != null)
            {
                ...
                if(requestPacket.SlotOffset >=0 && requestPacket.SlotOffset < Count)
                {
