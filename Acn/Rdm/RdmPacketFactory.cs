...
namespace Acn.Rdm
{
    public static class RdmPacketFactory
    {
        ...
        private static void RegisterSensorMessages()
        {
            ...
            //SensorValue
            RegisterPacketType(RdmCommands.Get, RdmParameters.SensorValue, typeof(SensoreValue.Get));
            RegisterPacketType(RdmCommands.GetResponse, RdmParameters.SensorValue, typeof(SensoreValue.GetReply));
        ...
        public static RdmPacket Build(RdmHeader header)
        {
            ...
            return PacketStore.TryGetValue(new PacketKey(header.Command, header.ParameterId), out var packetType) ? 
                RdmPacket.Create(header, packetType) : 
                null;
        }
